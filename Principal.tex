% Arquivo Principal para Formatação de TCCs - UDESC CEPLAN
...
\campus{Centro de Educação do Planalto Norte - CEPLAN}
...
% Folha de Rosto
% ---
\inforosto{Trabalho de Conclusão de Curso apresentado ao curso de Bacharelado em Sistemas de Informação como requisito parcial para a obtenção do título de Bacharel em Sistemas de Informação.}
\orientador{Nome do Orientador}
\orientadorRotulo{Dr./Msc. }
